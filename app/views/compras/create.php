    ...
    <div class="zf-main">
        ...
        <div class="zf-content">
            ...
            <div style="display:flex; align-items:center; gap:12px; margin-bottom:24px;">
                ...
                <div>
                    <h1 style="font-size:20px; font-weight:700; margin:0;">Nova Compra</h1>
                    <span style="font-size:13px; color:var(--text-tertiary);">Preencha os dados e adicione os produtos</span>
                </div>
            </div>
            ...
            <form method="POST" action="/compras/criar" id="form-compra">
                ...
                <div style="display:grid; grid-template-columns:1fr 380px; gap:20px; align-items:start;">
                    ...
                    <div style="display:flex; flex-direction:column; gap:20px;">
                        ...
                        <div class="zf-table-card" style="padding:24px;">
                            ...
                            <textarea name="observacao" class="form-control" rows="3"
                                ...
                                style="resize:vertical;"><?= e(old('observacao')) ?></textarea>
                        </div>
                    ...
                    <div style="display:flex; flex-direction:column; gap:20px; position:sticky; top:16px;">
                            ...
                            <div style="display:flex; flex-direction:column; gap:14px;">
                                <div>
                                    ...
                                    <select name="forma_pagamento" class="form-control">
                                        ...
                                        <option value="prazo" <?= old('forma_pagamento') === 'prazo'      ? 'selected' : '' ?>>A Prazo</option>
                                    </select>
                                </div>
                        ...
                        <!-- Ações -->
                        <div style="display:flex; flex-direction:column; gap:10px;">
                            <button type="submit" name="acao" value="salvar" class="btn btn-primary" style="width:100%; justify-content:center;">
                                <i class="ti ti-device-floppy"></i> Salvar como Rascunho
                            </button>
                            <a href="/compras" class="btn btn-outline" style="width:100%; justify-content:center;">
                                Cancelar
                            </a>
                        </div>
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:12px;">
                <div>
                    ...
                    <input type="number" id="modal-qtd" class="form-control"
                        step="0.001" min="0.001" placeholder="0" value="1">
                </div>
                <div>
                    <label style="font-size:12px; color:var(--text-tertiary); display:block; margin-bottom:4px;">
...
<div id="modal-novo-produto" style="
    ...
    <div class="zf-table-card" style="width:480px; padding:28px; max-height:90vh; overflow-y:auto;">
        ...
        <div id="mnp-erro" style="display:none;" class="zf-alert zf-alert-danger" data-auto-close>
...
<script>
    (function() {
        ...
        function renderTabela() {
            // Remove linhas de produto (mantém linha-vazia)
        ...
        selProduto.addEventListener('change', () => {
            ...
            if (opt && opt.dataset.custo) {
                inputPreco.value = opt.dataset.custo;
            }
            atualizarPreview();
        });
    ...
    document.getElementById('mnp-fechar').addEventListener('click', fecharModalNovoProduto);
    document.getElementById('mnp-cancelar').addEventListener('click', fecharModalNovoProduto);

    modalNP.addEventListener('click', e => {
        if (e.target === modalNP) fecharModalNovoProduto();
    });
    ...
    document.getElementById('mnp-salvar').addEventListener('click', async () => {
        ...
        try {
            ...
            // ================================
            // SELECT DO MODAL PRINCIPAL
            // ================================
            const selProduto = document.getElementById('modal-produto');
            // troca pelo ID real do seu select caso seja diferente

            const inputPreco = document.getElementById('mnp-custo');
            // troca pelo ID real do campo de preço

            if (!selProduto) {
                throw new Error('Select de produtos não encontrado.');
            }
            ...
            // dispara change caso tenha eventos dependentes
            selProduto.dispatchEvent(new Event('change'));

            // preço automático
            if (inputPreco && parseFloat(p.preco_venda) > 0) {
                inputPreco.value = parseFloat(p.preco_venda).toFixed(2);
            }
