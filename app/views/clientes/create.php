...
<div class="zf-layout">
    ...
    <div class="zf-main">
        ...
        <div class="zf-content">
            ...
            <form method="POST" action="/clientes/criar" id="form-cliente">
                <?= csrf_field() ?>
                            ...
                            <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                                ...
                                <div class="form-group" style="grid-column:1/-1;">
                                    <label class="form-label">
                                        Nome <span id="label-nome-pj" style="display:none"> / Razão Social</span>
                                ...
                                <div class="form-group">
                                    <label class="form-label" id="label-cpf-cnpj">CPF</label>
                        ...
                        <div class="zf-table-card" style="padding:20px 24px;">
                            ...
                            <div style="display:flex; flex-direction:column; gap:10px;">
                                <button type="submit" class="btn btn-primary" style="width:100%;">
                                    <i class="ti ti-check"></i> Cadastrar Cliente
                                </button>
                                <a href="/clientes" class="btn btn-outline" style="width:100%; text-align:center;">
...
<script>
    ...
    alternarTipoPessoa(document.querySelector('[name=tipo_pessoa]:checked')?.value ?? 'fisica');
</script>
